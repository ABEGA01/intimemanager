...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Vérification de la référence unique (sauf pour l'article en cours)
        $stmt = $con->prepare("SELECT COUNT(*) FROM article WHERE REFERENCE = :reference AND IDARTICLE != :id");
        $stmt->execute(['reference' => $reference, 'id' => $idArticle]);
        if ($stmt->fetchColumn() > 0) {
            throw new Exception('Cette référence existe déjà');
        }

        // Mise à jour de l'article
        $stmt = $con->prepare("UPDATE article SET 
                              REFERENCE = :reference,
                              NOMARTICLE = :nom,
        ...
        $stmt = $con->prepare("INSERT INTO journal_action (IDUTILISATEUR, ACTION, DETAILS) 
                              VALUES (:id, 'MODIFICATION_ARTICLE', 'Modification de l\'article : ' || :nom)");
        $stmt->execute([
...
<head>
    ...
    <title>Modifier l'Article - Gestion de Stock</title>
    <!-- Bootstrap CSS -->
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="reference" name="reference" 
                                           value="<?php echo htmlspecialchars($article['REFERENCE']); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="nom" class="form-label">Nom *</label>
                                    <input type="text" class="form-control" id="nom" name="nom" 
                                           value="<?php echo htmlspecialchars($article['NOMARTICLE']); ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="prix_achat" name="prix_achat" 
                                               step="0.01" min="0" value="<?php echo $article['PRIXACHAT']; ?>" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="prix_vente" name="prix_vente" 
                                               step="0.01" min="0" value="<?php echo $article['PRIXVENTE']; ?>" required>
                                        <span class="input-group-text">€</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="quantite" name="quantite" 
                                           min="0" value="<?php echo $article['QUANTITESTOCK']; ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="seuil_alerte" name="seuil_alerte" 
                                           min="0" value="<?php echo $article['SEUILALERTE']; ?>" required>
                                </div>
                            </div>
                                    ...
                                    <select class="form-select" id="categorie" name="categorie" required>
                                        ...
                                        <?php foreach ($categories as $categorie): ?>
                                            <option value="<?php echo $categorie['IDCATEGORIE']; ?>"
                                                    <?php echo $categorie['IDCATEGORIE'] == $article['IDCATEGORIE'] ? 'selected' : ''; ?>>
                                    ...
                                    <select class="form-select" id="fournisseur" name="fournisseur" required>
                                        ...
                                        <?php foreach ($fournisseurs as $fournisseur): ?>
                                            <option value="<?php echo $fournisseur['IDFOURNISSEUR']; ?>"
                                                    <?php echo $fournisseur['IDFOURNISSEUR'] == $article['IDFOURNISSEUR'] ? 'selected' : ''; ?>>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="taille" name="taille" 
                                           value="<?php echo htmlspecialchars($article['TAILLE']); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="couleur" class="form-label">Couleur</label>
                                    <input type="text" class="form-control" id="couleur" name="couleur" 
                                           value="<?php echo htmlspecialchars($article['COULEUR']); ?>">
                                </div>
                            </div>
